...
public class PaginaAnuncioDoaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        anuncioType = view.findViewById(R.id.pagina_anuncio_type_doa);
        anuncioType.setText("DOAÇÃO");

        anuncioTitulo = view.findViewById(R.id.pagina_titulo_anuncio_doa);
        anuncioTitulo.setText(anuncioAtual.getTitulo());

        anuncioDescricao = view.findViewById(R.id.descricao_pagina_anuncio_doa);
        anuncioDescricao.setText(anuncioAtual.getDescricao());

        //Define a data do anúncio na página
        anuncioData = view.findViewById(R.id.data_criacao_anuncio_doa);
        ...
        anuncioAutor = view.findViewById(R.id.nome_autor_anuncio_doa);
        ...
        favoritoView = view.findViewById(R.id.coracao_fav_pag_doa);
        ...
        seguirBtn = view.findViewById(R.id.btn_seguir_anuncio_doa);
        setupJaSeguindo();
